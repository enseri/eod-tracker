...
// Scaled for realistic member income: top rank is $5K/mo (nobody is doing $1M/mo).
const MONTHLY_RANKS = [
  { key: 'starter', label: 'Starter', threshold: 100, color: '#5ad1b4', emoji: '🌱' },
  { key: 'closer', label: 'Closer', threshold: 250, color: '#4ea1ff', emoji: '🤝' },
  { key: 'earner', label: 'Earner', threshold: 500, color: '#7c5cff', emoji: '💵' },
  { key: 'heavyweight', label: 'Heavyweight', threshold: 1000, color: '#b06bff', emoji: '🥊' },
  { key: 'rainmaker', label: 'Rainmaker', threshold: 1500, color: '#f5c842', emoji: '🌧️' },
  { key: 'mogul', label: 'Mogul', threshold: 2000, color: '#ff9f43', emoji: '🏦' },
  { key: 'titan', label: 'Titan', threshold: 3000, color: '#ff6b5b', emoji: '🗿' },
  { key: 'magnate', label: 'Magnate', threshold: 4000, color: '#ff4d8d', emoji: '👑' },
  { key: 'empire', label: 'Empire', threshold: 5000, color: '#d6b4ff', emoji: '🏛️' },
];

// Always-tracked monthly (MTD) broadcast milestones — $100/mo → $5K/mo.
const MONTHLY_MILESTONES = [
  100, 250, 500, 750, 1000, 1500, 2000, 3000, 4000, 5000,
];

// Opt-in all-time cumulative broadcast milestones — $1K → $1M (accrues over time).
