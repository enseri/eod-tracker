 ...
 */
function formatEodChannelMessage({ entry, date, username, streak, isPro, streakNotifications = true }) {
  const e = entry || {};
  ...
  const milestone = streakNotifications ? getStreakMilestone(n) : null;
  if (milestone) {
